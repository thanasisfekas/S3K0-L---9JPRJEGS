...
class SearchAppointmentScreen:
    def __init__(self, root, on_submit, back_command=None):
        ...
        tk.Label(root, text="Select Appointment Date", font=("Arial", 18, "bold"), bg="#ffffff", fg="#1a1c3d").pack(pady=50)
        ...
        tk.Button(root, text="Continue", font=("Arial", 12, "bold"), bg="#007bff", fg="white", relief="flat", height=2, command=self.submit).pack(fill="x", padx=60, pady=40)
