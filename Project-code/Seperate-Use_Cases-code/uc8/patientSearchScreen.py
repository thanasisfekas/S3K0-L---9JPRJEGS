...
class PatientSearchScreen:
    def __init__(self, root, controller=None):
        ...
        font=("Segoe UI", 10), 
        bg="#ffffff", 
        fg="#7f8c8d").pack(anchor="w", padx=5)
        ...
        self.search_entry.pack(pady=(0, 10), ipady=5, padx=5)
        ...
        self.id_entry = tk.Entry(search_container, 
        font=("Segoe UI", 12), 
        width=35,
         bd=0, 
         highlightthickness=1, 
         highlightbackground="#bdc3c7")
        self.id_entry.pack(pady=(0, 10), ipady=5, padx=5)
    ...
    def handle_search(self):
        data = self.getInput()
        self.controller.searchPatient(data)
