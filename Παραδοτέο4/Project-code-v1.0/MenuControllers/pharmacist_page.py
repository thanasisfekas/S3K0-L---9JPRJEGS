...
UC8_DIR = Path(__file__).resolve().parents[1] / "Seperate-Use_Cases-code" / "UseCase8"
...
class PharmacistPortalFrame(ctk.CTkFrame):
    def __init__(self, parent, controller):
        ...
        self.lbl_title = ctk.CTkLabel(self.top_bar, text="✚ Vitalink | Pharmacist Portal", font=ctk.CTkFont(size=20, weight="bold"), text_color="#3D59AB")
